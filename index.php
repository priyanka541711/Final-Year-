	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">Learner </h1>
			</div>
					...
					<div class="slider-content">
						...
						<div class="text">      <!-- jquery typed effect -->
							...
							<div class="social-networks">
								<a href="https://www.facebook.com/priyanka.pandya.3954" class="fa fa-facebook"></a>
								<a href="https://twitter.com/priya2610pandya" class="fa fa-twitter"></a>
								<a href="https://www.instagram.com/priya_382011" class="fa fa-instagram"></a>
								<a href="https://www.linkedin.com/in/priyanka-pandya-9258911a6" class="fa fa-linkedin"></a>
		...
		<section class="header7 cid-rjrjygOfd1" id="header7-3">
			...
			<div class="container">
				<div class="row">
						...
						<div id="team-memebers" class="rounded mx-auto d-block">
							<div class="team-member text-center">
							<img src="img/Priyanka.jpeg" class="rounded" style="width:200px; height: 200px;" alt="image">
									<div class="team-member-info text-center">
									<h4 class="team-member-name">Priyanka Pandya</h4>
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
												Learner  is an online E-learning website <br>
